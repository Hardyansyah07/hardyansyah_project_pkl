            ...
            <div class="row align-items-center">
               <div class="col-xl-7 col-lg-12 col-md-12 col-12">
                  <div class="tp-breadcrumb">
                     ...
                     <h2 class="tp-breadcrumb__title">Sign In</h2>
                  </div>
               </div>
            </div>
         </div>
         ...
         <div class="container">
            <div class="row justify-content-center">
               <div class="col-lg-6 col-sm-12">
                  <div class="tptrack__product mb-40">
                     <div class="tptrack__thumb">
                        <img src="{{asset('frontend/assets/img/banner/login-bg.jpg')}}" alt="">
                     </div>
                     <div class="tptrack__content grey-bg-3">
                        <div class="tptrack__item d-flex mb-20">
                           <div class="tptrack__item-icon">
                              <img src="{{asset('frontend/assets/img/icon/lock.png')}}" alt="">
                           </div>
               ...
               <div class="col-lg-6 col-sm-12">
                  <div class="tptrack__product mb-40">
                     <div class="tptrack__thumb">
                        <img src="{{asset('frontend/assets/img/banner/sign-bg.jpg')}}" alt="">
                     </div>
                     <div class="tptrack__content grey-bg-3">
                        <div class="tptrack__item d-flex mb-20">
                           <div class="tptrack__item-icon">
                              <img src="{{asset('frontend/assets/img/icon/sign-up.png')}}" alt="">
                           </div>
                           <div class="tptrack__item-content">
